...
def remove_extra_spaces(text: str) -> str:
    """
    Description:
        Remove extra spaces from a given text string.

    This function uses a regular expression to replace multiple spaces
    with a single space and trims leading and trailing spaces.
