...
def find_phone_numbers(text: str) -> list:
    """
    Description:
        Find phone numbers in a given text string.

    This function uses a regular expression to find all phone numbers
    consisting of exactly 10 digits within the provided text.
